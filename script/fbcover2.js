...
module.exports.run = async function({ api, event, args }) {
    try {
        ...
        if (!name || !birthday || !love || !location || !hometown || !follow || !gender) {
            return api.sendMessage("Please provide all required parameters: name, birthday, love, location, hometown, follow, and gender.", event.threadID);
        }
        ...
        writer.on('finish', async () => {
            ...
            api.sendMessage("Processing Cover Photo, wait for a moment...", event.threadID);
